...
function randomQuote() {
  var e = [
      ...
      "There is no excellent beauty that hath not some strangeness in its proportions.",
      "Children are fantastic little creatures, because next to drunk people, they are the only truly honest people on earth.",
  ...
  document.getElementById("quote").innerHTML =
    "&ldquo;" + e[n] + "&rdquo; &mdash; <small>" + t[n] + "</small>";
}
function randomBackground(e) {
  var t = ["buildings", "nature", "objects"],
  ...
  "daily" == e || "weekly" == e
    ...
    : r
        ...
        .fromCategory(t[n])
        .fetch(),
    (document.body.style.backgroundImage = "url(" + r.url + ")");
}
  ...
  chrome.bookmarks.getTree(function(t) {
    t.forEach(function(t) {
      t.children[0].children.forEach(function(t) {
        t.children &&
          e >= 1 &&
          (console.log(t.title + " " + t.title.charAt(0).toLowerCase()),
  ...
  $.each($(".parent"), function(e, t) {
    ...
    Mousetrap.bind("alt+g", function() {
      window.location.href =
        "https://github.com/pschfr/start/projects/2?fullscreen=true";
    }),
    ...
    (o.onreadystatechange = function() {
      if (4 == o.readyState && 200 == o.status) {
        var t = JSON.parse(o.responseText),
          n = "";
        "clear-day" == t.currently.icon
          ? (n = "sun")
          : "clear-night" == t.currently.icon
          ? (n = "moon")
          : "rain" == t.currently.icon
          ? (n = "rain")
          : "snow" == t.currently.icon
          ? (n = "snow")
          : "sleet" == t.currently.icon
          ? (n = "sleet")
          : "wind" == t.currently.icon
          ? (n = "wind")
          : "fog" == t.currently.icon
          ? (n = "fog")
          : "cloudy" == t.currently.icon
          ? (n = "cloud")
          : "partly-cloudy-day" == t.currently.icon
          ? (n = "cloud sun")
          : "partly-cloudy-night" == t.currently.icon && (n = "cloud moon"),
          "snow" == t.currently.icon || "sleet" == t.currently.icon
            ? participate("snow")
            : "rain" == t.currently.icon && participate("rain"),
          (document.getElementById("weather").innerHTML =
            '<a id="weatherlink" href="https://darksky.net/forecast/' +
            e +
            '"><span class="climacon ' +
            n +
            '"></span> ' +
            t.currently.summary +
            ", " +
            Math.round(t.currently.temperature) +
            "&deg;</a>"),
          (document.getElementById(
            "details"
          ).innerHTML = t.hourly.summary.replace(",", ",<br/>"));
      }
    }),
    o.send(null);
}
  ...
  o.open("GET", n, !0),
    (o.onreadystatechange = function() {
      if (4 == o.readyState && 200 == o.status) {
        ...
        t["@attr"] && "" !== t["@attr"].nowplaying
          ? (r.innerHTML =
              '<span title="' +
              e +
              ' total streamed">currently listening to:</span> ')
          : (r.innerHTML =
              '<span title="' +
              e +
              ' total streamed">last listened to:</span> '),
          (r.innerHTML +=
            '<a href="' +
            t.url +
            '" title="on album: ' +
...
function participate(e) {
  ...
  setInterval(function() {
    ...
    for (
      flake = {},
        flake.x = 1.5 * n.width * i.random() - 0.5 * n.width,
        flake.y = -9,
        flake.velX = 2 * a * (i.random() / 2 + 0.5),
        flake.velY = (4 + 2 * i.random()) * a,
        flake.radius = i.pow(5 * t, 2) / 5,
        flake.update = function() {
          var t = this;
          (t.x += t.velX),
            (t.y += t.velY),
            r.beginPath(),
            r.arc(t.x, t.y, t.radius, 0, 2 * i.PI, !1),
            "snow" == e
              ? (r.fillStyle = "#FFF")
              : "rain" == e && (r.fillStyle = "#00F"),
            r.fill();
        },
        o.push(flake),
        b = 0;
      ...
      o[b].y > n.height ? o.splice(b, 1) : o[b].update();
  }, 16);
}
  ...
  (element = document.getElementById("gmail")),
    ...
    (xmlhttp.onreadystatechange = function() {
      if (4 == xmlhttp.readyState && 200 == xmlhttp.status) {
        ...
        if (
          ((entryList = r + ":\n"), (plural = o > 1 ? "s" : ""), 0 == i.length)
        )
          element.innerHTML =
            "<p><a href='" +
            e.replace("/feed/atom", "") +
            "' id='emaillink'>Inbox zero. Enjoy your day.</a></p>\n";
        else {
...
!(function(e, t) {
  ...
  function n(e, t, n) {
    ...
    if (((o.text = e), n)) for (r in xe) n[r] && (o[r] = n[r]);
  ...
  function u(e) {
    var t = {};
    return (
      Te.each(e.match(He) || [], function(e, n) {
        t[n] = !0;
      }),
      t
    );
    ...
    for (var n, r, o = [], i = 0, a = e.length; i < a; i++)
      (r = e[i]),
        r.style &&
          ...
          t
            ? ("none" === n &&
                ((o[i] = $e.get(r, "display") || null),
                o[i] || (r.style.display = "")),
              "" === r.style.display && Ve(r) && (o[i] = b(r)))
            : "none" !== n && ((o[i] = "none"), $e.set(r, "display", n)));
    ...
    return (
      (n =
        "undefined" != typeof e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && i(e, t)) ? Te.merge([e], n) : n
    );
  }
  function T(e, t) {
  ...
  function L(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        $e.hasData(e) &&
        ((i = $e.access(e)), (a = $e.set(t, i)), (l = i.events))
      ) {
  ...
  function M(e, t, r, o) {
    ...
    var i,
      ...
      h = t[0],
      y = ve(h);
    if (y || (p > 1 && "string" == typeof h && !me.checkClone && ut.test(h)))
    ...
    if (
      p &&
      ((i = k(t, e[0].ownerDocument, !1, e, o)),
      (a = i.firstChild),
      1 === i.childNodes.length && (i = a),
      a || o)
    ) {
      for (s = Te.map(w(i, "script"), D), u = s.length; f < p; f++)
        (l = i),
          f !== d &&
  ...
  function H(e, t, n) {
    for (var r, o = t ? Te.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
  ...
  function _(e, t, n, r, o, i) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += Te.css(e, n + Ke[a], !0, o)),
        r
          ? ("content" === n && (u -= Te.css(e, "padding" + Ke[a], !0, o)),
            "margin" !== n &&
              (u -= Te.css(e, "border" + Ke[a] + "Width", !0, o)))
          : ((u += Te.css(e, "padding" + Ke[a], !0, o)),
            "padding" !== n
              ? (u += Te.css(e, "border" + Ke[a] + "Width", !0, o))
              : (s += Te.css(e, "border" + Ke[a] + "Width", !0, o)));
    return (
      !r &&
        i >= 0 &&
        (u += Math.max(
  ...
  function K(e, t, n) {
    ...
    for (r in t)
      if (((o = t[r]), wt.test(o))) {
        if (
          (delete t[r], (i = i || "toggle" === o), o === (y ? "hide" : "show"))
        ) {
    ...
    if (((u = !Te.isEmptyObject(t)), u || !Te.isEmptyObject(d))) {
      ...
      for (r in d)
        u ||
          ...
          (u = X(y ? g[r] : 0, r, p)),
          r in g || ((g[r] = u.start), y && ((u.end = u.start), (u.start = 0)));
    }
  }
  function V(e, t) {
    var n, r, o, i, a;
  ...
  function Y(e, t, n) {
    ...
    for (V(c, l.opts.specialEasing); i < a; i++)
      if ((r = Y.prefilters[i].call(l, e, c, l.opts)))
        return (
          ve(r.stop) &&
    ...
    return (
      Te.map(c, X, l),
      ve(l.opts.start) && l.opts.start.call(e, l),
      l
  ...
  (Te.fn = Te.prototype = {
        ...
        if (null != (e = arguments[s]))
          for (t in e)
            (n = a[t]),
              (r = e[t]),
              a !== r &&
                (l && r && (Te.isPlainObject(r) || (o = Array.isArray(r)))
                  ? (o
                      ? ((o = !1), (i = n && Array.isArray(n) ? n : []))
                      : (i = n && Te.isPlainObject(n) ? n : {}),
                    (a[t] = Te.extend(l, i, r)))
                  : void 0 !== r && (a[t] = r));
      return a;
    }),
      ...
      isPlainObject: function(e) {
        ...
        return (
          ...
          (!(t = se(e)) ||
            ...
            "function" == typeof n && ye.call(n) === ge))
        );
      },
    ...
    "function" == typeof Symbol &&
      (Te.fn[Symbol.iterator] = ie[Symbol.iterator]),
    Te.each(
  ...
  var Ce = (function(e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : $) !== M && q(t), (t = t || M), P)
      ) {
        if (11 !== h && (u = me.exec(e)))
          if ((o = u[1])) {
            if (9 === h) {
            ...
            } else if (p && (a = p.getElementById(o)) && B(t, a) && a.id === o)
              return n.push(a), n;
          } else {
      ...
      var o = n.length > 0,
        ...
        a = function(r, a, s, u, l) {
          ...
          for (
            ...
            if (i && c) {
              for (
                f = 0, a || c.ownerDocument === M || (q(c), (s = !P));
                (p = e[f++]);
          ...
          if (((d += h), o && h !== d)) {
            ...
            if (r) {
              if (d > 0) for (; h--; ) y[h] || g[h] || (g[h] = G.call(u));
              g = m(g);
            }
            Q.apply(u, g),
              l && !r && g.length > 0 && d + n.length > 1 && t.uniqueSort(u);
          }
          return l && ((F = x), (D = v)), y;
        };
      return o ? r(a) : a;
    ...
    try {
      Q.apply((Y = Z.call($.childNodes)), $.childNodes),
      ...
      (q = t.setDocument = function(e) {
        ...
        return r !== M && 9 === r.nodeType && r.documentElement
          ? ((M = r),
            ...
            (T.getElementsByClassName = ge.test(M.getElementsByClassName)),
            (T.getById = o(function(e) {
              return (
                (H.appendChild(e).id = _),
                !M.getElementsByName || !M.getElementsByName(_).length
              );
            })),
            T.getById
            ...
            (I = []),
            (O = []),
            (T.qsa = ge.test(M.querySelectorAll)) &&
              (o(function(e) {
                  ...
                  return n
                    ...
                    : ((n =
                      ...
                      (!T.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === M || (e.ownerDocument === $ && B($, e))
                          ? -1
                          : t === M || (t.ownerDocument === $ && B($, t))
                          ? 1
                          : j
                          ? ee(j, e) - ee(j, t)
                          : 0
      ...
      (A = t.select = function(e, t, n, r) {
        ...
        if (((n = n || []), 1 === c.length)) {
          if (
            ...
            if (
              ((t = (k.find.ID(a.matches[0].replace(be, xe), t) || [])[0]), !t)
            )
              return n;
          ...
          for (
            ...
            if (
              ...
              (r = u(
                ...
                (ve.test(i[0].type) && f(t.parentNode)) || t
              ))
            ) {
  ...
  (Te.filter = function(e, t, n) {
    ...
    Te.fn.extend({
        ...
        if ("string" != typeof e)
          return this.pushStack(
            Te(e).filter(function() {
              for (t = 0; t < r; t++) if (Te.contains(o[t], this)) return !0;
            })
          );
      ...
      is: function(e) {
        return !!a(
          this,
          "string" == typeof e && Ne.test(e) ? Te(e) : e || [],
          !1
        ).length;
      }
    });
      ...
      if (((n = n || De), "string" == typeof e)) {
        ...
        if (r[1]) {
          if (
            ...
            Ae.test(r[1]) && Te.isPlainObject(t))
          )
    ...
    Te.each(
      ...
      function(e, t) {
        Te.fn[e] = function(n, r) {
          ...
          return (
            "Until" !== e.slice(-5) && (r = n),
            r && "string" == typeof r && (o = Te.filter(r, o)),
            this.length > 1 &&
              (Me[e] || Te.uniqueSort(o), qe.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    Te.extend({
          ...
          o = {
            ...
            then: function(t, r, o) {
              ...
              return Te.Deferred(function(e) {
                n[0][3].add(i(0, e, ve(o) ? o : l, e.notifyWith)),
                  n[1][3].add(i(0, e, ve(t) ? t : l)),
                  n[2][3].add(i(0, e, ve(r) ? r : c));
              }).promise();
            },
            promise: function(e) {
      ...
      when: function(e) {
        ...
        if (
          ...
          "pending" === i.state() || ve(o[n] && o[n].then))
        )
          return i.then();
    ...
    Te.extend({
      ...
      ready: function(e) {
        (e === !0 ? --Te.readyWait : Te.isReady) ||
          ((Te.isReady = !0),
          (e !== !0 && --Te.readyWait > 0) || Oe.resolveWith(ae, [Te]));
      }
    }),
    ...
    Te.fn.extend({
      data: function(e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = Fe.get(i)), 1 === i.nodeType && !$e.get(i, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
      ...
      if (g)
        for (
          n.handler && ((i = n), (n = i.handler), (o = i.selector)),
            o && Te.find.matchesSelector(nt, o),
            n.guid || (n.guid = Te.guid++),
            (u = g.events) || (u = g.events = {}),
            (a = g.handle) ||
              (a = g.handle = function(t) {
                return "undefined" != typeof Te && Te.event.triggered !== t.type
  ...
  Te.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (t)
        if (n)
          for (i = i || w(e), a = a || w(s), r = 0, o = i.length; r < o; r++)
            L(i[r], a[r]);
        else L(e, s);
      return (
      ...
      for (var t, n, r, o = Te.event.special, i = 0; void 0 !== (n = e[i]); i++)
        if (_e(n)) {
          if ((t = n[$e.expando])) {
            if (t.events)
              for (r in t.events)
                o[r] ? Te.event.remove(n, r) : Te.removeEvent(n, r, t.handle);
            n[$e.expando] = void 0;
          }
    ...
    Te.each(
      ...
      function(e, t) {
        Te.fn[e] = function(e) {
          for (var n, r = [], o = Te(e), i = o.length - 1, a = 0; a <= i; a++)
        ...
        return Ie(
          ...
          function(e, t, n) {
            var r,
              ...
              a = 0;
            if (Array.isArray(t)) {
              for (r = ft(e), o = t.length; a < o; a++)
                i[t[a]] = Te.css(e, t[a], !1, r);
              return i;
            }
          ...
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === i && Te.isXMLDoc(e)) ||
                (o =
                  ...
                  (Te.expr.match.bool.test(t) ? kt : void 0)),
              void 0 !== n
                ? null === n
        ...
        if (arguments.length)
          return (
            ...
            this.each(function(n) {
              var o;
              1 === this.nodeType &&
                ((o = r ? e.call(this, n, Te(this).val()) : e),
                null == o
                  ? (o = "")
                  : "number" == typeof o
                  ? (o += "")
    ...
    Te.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function(e, t) {
            for (
              var n, r, o = e.options, i = Te.makeArray(t), a = o.length;
              a--;

            )
              (r = o[a]),
                (r.selected = Te.inArray(Te.valHooks.option.get(r), i) > -1) &&
                  (n = !0);
      ...
      ajax: function(t, n) {
        function r(t, n, r, s) {
          ...
          c ||
            ...
            l
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (T = "notmodified")
                  : ((T = x.state), (p = x.data), (d = x.error), (l = !d)))
            ...
            k.statusCode(b),
            (b = void 0),
            f && g.trigger(l ? "ajaxSuccess" : "ajaxError", [k, h, l ? p : d]),
            v.fireWith(y, [k, T]),
            f &&
        ...
        (f = Te.event && h.global),
          ...
          h.hasContent
            ...
            : ((d = h.url.slice(i.length)),
              h.data &&
                ...
                ((i += (qt.test(i) ? "&" : "?") + h.data), delete h.data),
              h.cache === !1 &&
                ((i = i.replace(Bt, "$1")),
                (d = (qt.test(i) ? "&" : "?") + "_=" + Lt++ + d)),
              (h.url = i + d)),
          h.ifModified &&
            (Te.lastModified[i] &&
              k.setRequestHeader("If-Modified-Since", Te.lastModified[i]),
            Te.etag[i] && k.setRequestHeader("If-None-Match", Te.etag[i])),
        ...
        if (h.beforeSend && (h.beforeSend.call(y, k, h) === !1 || c))
          return k.abort();
        if (
          ((T = "abort"),
          v.add(h.complete),
  ...
  Te.ajaxSetup({
    ...
    Te.ajaxPrefilter("json jsonp", function(t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (o = t.jsonpCallback = ve(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
            ? (t[s] = t[s].replace(Jt, "$1" + o))
            : t.jsonp !== !1 &&
              (t.url += (qt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
  ...
  return (
    (Te.noConflict = function(t) {
      return (
        e.$ === Te && (e.$ = Zt), t && e.jQuery === Te && (e.jQuery = Qt), Te
      );
    }),
    t || (e.jQuery = e.$ = Te),
    Te
  ...
  (function(e, t, n) {
    ...
    function c() {
      if (!g) {
        g = {};
        for (var e in m)
          (e > 95 && e < 112) || (m.hasOwnProperty(e) && (g[m[e]] = e));
      }
      return g;
    }
    function f(e, t, n) {
      return (
        n || (n = c()[e] ? "keydown" : "keypress"),
    ...
    function d(e, t) {
      var n,
        ...
        o,
        i = [];
      for (n = p(e), o = 0; o < n.length; ++o)
        (r = n[o]),
          x[r] && (r = x[r]),
          t && "keypress" != t && b[r] && ((r = b[r]), i.push("shift")),
          l(r) && i.push(r);
      return (t = f(r, i, t)), { key: r, modifiers: i, action: t };
    }
    function h(e, n) {
    ...
    function y(e) {
      ...
      function f(e, t, n, r) {
        v.stopCallback(t, t.target || t.srcElement, n, r) ||
          (e(t, n) === !1 && (s(t), u(t)));
      }
      function p(e) {
      ...
      function m(e, t, n, r, o) {
        ...
        return a.length > 1
          ? void g(e, a, t, n)
          : ((i = d(e, n)),
            (v._callbacks[i.key] = v._callbacks[i.key] || []),
            c(i.key, i.modifiers, { type: i.action }, r, e, o),
            void v._callbacks[i.key][r ? "unshift" : "push"]({
              callback: t,
      ...
      (v._handleKey = function(e, t, r) {
        ...
        for (o = 0; o < i.length; ++o)
          i[o].seq && (s = Math.max(s, i[o].level));
        for (o = 0; o < i.length; ++o)
          if (i[o].seq) {
            if (i[o].level != s) continue;
            (u = !0),
              (a[i[o].seq] = 1),
              f(i[o].callback, r, i[o].combo, i[o].seq);
  ...
  (function(e, t) {
    ...
    (n.prototype.find = function(e) {
      ...
      (n.prototype.size = function(e, t) {
        return (this.dimensions = { width: e, height: t || e }), this;
      }),
      (n.prototype.randomize = function(e) {
        return (
          "daily" == e || "weekly" == e
            ? (this.randomizationInterval = e)
            : (this.randomizationInterval = "perRequest"),
          this
        );
      }),
      ...
      (n.prototype._appendRandomization = function(e) {
        return (
          e && "perRequest" == this.randomizationInterval
            ? (this.url += "/random")
  ...
  $(function() {
    startTime(),
      ...
      document
        ...
        .addEventListener("click", resetMousetraps, !1),
      document
        .getElementById("modal")
        .addEventListener("click", closeModal, !1);
  });
